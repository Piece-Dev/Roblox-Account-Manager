...
To install, click the **[Download Latest](https://github.com/Piece-Dev/Roblox-Account-Manager/releases/download/3.2/RobloxAccountManager.zip)** button to download the latest `.zip` file. After downloading, extract the ZIP and then run the **Roblox Account Manager.exe** file to start the application.
